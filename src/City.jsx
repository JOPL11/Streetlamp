                ...
                convoy2.traverse((child) => {
                  ...
                  convoy3.traverse((child) => {
                    ...
                    useEffect(() => {
                      ...
                      blimper
                        .to(BlimpRef.current.rotation, { y: 1.10, duration: 50, ease: 'Expo.Out', onComplete: () => console.log('blimp rotation one complete') })
                        .to(BlimpRef.current.position, { x: -2.8, y: 5.5, z: 12, duration: 80, ease: 'Expo.In', onComplete: () => console.log('blimp rotation one commencing') }, "-=40")
                        ...
                        .to(BlimpRef.current.rotation, { y: 2.50, duration: 80, ease: 'Expo.In', onComplete: () => console.log('blimp rotation one complete') }, "-=40")
                    ...
                    delorean.traverse((child) => {
                      ...
                      useEffect(() => {
                        ...
                        tCars2
                          .to(deloreanRef.current.position, { x: -2.1, y: 2.5, z: -12, duration: 12, ease: 'power4.InOut' }) // First pass
                    ...
                    limo.traverse((child) => {
                      ...
                      useEffect(() => {
                        ...
                        tCars2
                          .to(limoRef.current.rotation, { y: 3.1, duration: 0 }) // Reposition
                          .to(limoRef.current.position, { x: -1.7, y: 2, z: -11, duration: 23, ease: 'power4.in', onStart: () => console.log('First') }) // First pass
                          .to(limoRef.current.rotation, { y: 0.12, duration: 1.8 }) // Reposition 180
                          .to(limoRef.current.position, { x: -1.7, y: 1, z: 22, duration: 13, ease: 'power2.out', onStart: () => console.log('Second') }) // Reposition at start
                          .to(limoRef.current.rotation, { y: 3.1, duration: 0.5 }) // Reposition 180
                          .to(limoRef.current.position, { x: 1.7, y: 2.8, z: -19, duration: 10, ease: 'power3.in', onStart: () => console.log('Third') }) // Reposition
                          .to(limoRef.current.rotation, { y: 0.12, duration: 1.5 }) // Reposition
                          .to(limoRef.current.position, { x: 1.7, y: 2.5, z: 22, duration: 8, ease: 'power3.out', onStart: () => console.log('Fourth') }) // Move to start
                          .to(limoRef.current.rotation, { y: 3.12, duration: 1.8 }) // Reposition 180
               ...
               diablo.traverse((child) => {
                 ...
                 useEffect(() => {
                  ...
                  tCarsee
                    ...
                    .to(diabloRef.current.position, { x: -2.1, y: 3.5, z: 14, duration: 7.1, ease: 'Expo.InOut',onUpdate: () => console.log('accident')  }) // Till first turn
                    .to(diabloRef.current.rotation, { y: 0.50, z: 1.05, duration: 5, ease: 'Expo.InOut',onComplete: () => console.log('crashpole') }, "-=4") // First turn
                    ...
                    .to(diabloRef.current.position, { x: 1.2, y: 1.2, z: 13.3, duration: 11, ease: 'Expo.out' }) // 
                    .to(diabloRef.current.position, { x: -0.9, y: 2.8, z: -13.3, duration: 22, ease: 'Expo.In' }) // Resume course till end
        ...
        useEffect(() => {
            ...
            // Add more animation steps as needed
                        ...
                        const diabloanimationParams2 = {
                            ...
                            finalPosition: { x: 3.3, y: 1.5, z: -11 },
                            rotationY: { start: +3.02, end: -0.20 },
                            duration: 3.2,
                        };
